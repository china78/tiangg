      ...
      >
        ...
        >
          ...
          <el-form-item label="高">
            <num
              onlypx
              :styleAttr.sync="info.height"
            ></num>
          </el-form-item>
          <el-form-item label="最大宽度">
            <num
              onlypx
              :styleAttr.sync="info['max-width']"
              :max="900"
            ></num>
          </el-form-item>
          <el-form-item label="最大高度">
            <num
              onlypx
              :styleAttr.sync="info['max-height']"
            ></num>
          </el-form-item>
          <el-form-item label="最小宽度">
            <num
              onlypx
              :styleAttr.sync="info['min-width']"
              :max="900"
            ></num>
          </el-form-item>
          <el-form-item label="最小高度">
            <num
              onlypx
              :styleAttr.sync="info['min-height']"
            ></num>
          </el-form-item>
        </el-form>
      </el-collapse-item>
      ...
      >
        ...
        >
          <el-form-item label="模式">
            ...
            >
              <el-option
                v-for="item in ['relative', 'absolute']"
                :key="item"
                :label="item"
                :value="item"
                :title="item"
          ...
          <el-form-item label="left">
            <num
              onlypx
              :styleAttr.sync="info.left"
            ></num>
          </el-form-item>
          <el-form-item label="top">
            <num
              onlypx
              :styleAttr.sync="info.top"
              :max="900"
            ></num>
          </el-form-item>
          <el-form-item label="right">
            <num
              onlypx
              :styleAttr.sync="info.right"
            ></num>
          </el-form-item>
          <el-form-item label="bottom">
            <num
              onlypx
              :styleAttr.sync="info.bottom"
            ></num>
          </el-form-item>
        </el-form>
      </el-collapse-item>
      ...
      >
        ...
        >
          <el-form-item label="图片">
            <resource
              type="image"
              :url.sync="backgroundImage"
            ></resource>
          </el-form-item>
          <el-form-item label="颜色">
            <el-color-picker
              v-model="info['background-color']"
              show-alpha
            ></el-color-picker>
          </el-form-item>
          <template v-if="backgroundImage">
            <el-form-item label="repeat">
              <el-select v-model="info['background-repeat']">
                <el-option
                  v-for="item in backgroundRepeat"
                  :key="item.val"
                  :label="item.desc"
                  :value="item.val"
                ></el-option>
            ...
            <el-form-item label="position">
              <el-select v-model="info['background-position']">
                <el-option
                  v-for="item in backgroundPosition"
                  :key="item.val"
                  :label="item.desc"
                  :value="item.val"
                ></el-option>
      ...
      >
        ...
        >
          <el-form-item label="top">
            <num
              onlypx
              :styleAttr.sync="info['padding-top']"
              :min="0"
              :max="50"
            ></num>
          </el-form-item>
          <el-form-item label="right">
            <num
              onlypx
              :styleAttr.sync="info['padding-right']"
              :min="0"
              :max="50"
            ></num>
          </el-form-item>
          <el-form-item label="bottom">
            <num
              onlypx
              :styleAttr.sync="info['padding-bottom']"
              :min="0"
              :max="50"
            ></num>
          </el-form-item>
          <el-form-item label="left">
            <num
              onlypx
              :styleAttr.sync="info['padding-left']"
              :min="0"
              :max="50"
            ></num>
          </el-form-item>
      ...
      >
        ...
        >
          <el-form-item label="top">
            <num
              onlypx
              :styleAttr.sync="info['margin-top']"
              :min="0"
              :max="50"
            ></num>
          </el-form-item>
          <el-form-item label="right">
            <num
              onlypx
              :styleAttr.sync="info['margin-right']"
              :min="0"
              :max="50"
            ></num>
          </el-form-item>
          <el-form-item label="bottom">
            <num
              onlypx
              :styleAttr.sync="info['margin-bottom']"
              :min="0"
              :max="50"
            ></num>
          </el-form-item>
          <el-form-item label="left">
            <num
              onlypx
              :styleAttr.sync="info['margin-left']"
              :min="0"
              :max="50"
            ></num>
          </el-form-item>
      ...
      >
        ...
        >
          <el-form-item label="宽度">
            <num
              onlypx
              :styleAttr.sync="info['border-width']"
              :min="0"
              :max="50"
            ></num>
          </el-form-item>
          ...
          <el-form-item label="圆角">
            <num
              onlypx
              :styleAttr.sync="info['border-radius']"
              :max="500"
            ></num>
          </el-form-item>
        </el-form>
