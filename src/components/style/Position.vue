      ...
      <div id="upper">
        ...
        <div class="layout horizontal center">
          ...
          <div class="content">
            <div
              v-show="notEmpty(info.top)"
              style="position: absolute; height: 0px; width: 84px; border-width: 1px 0px 0px; border-style: dashed; border-color: rgb(165, 165, 165); border-image: initial; left: 0px; top: 12px;"
            />
            <div
              v-show="notEmpty(info.left)"
              style="position: absolute; height: 84px; width: 0px; border-width: 0px 0px 0px 1px; border-style: dashed; border-color: rgb(165, 165, 165); border-image: initial; top: 0px; left: 12px;"
            />
            <div
              v-show="notEmpty(info.right)"
              style="position: absolute; height: 84px; width: 0px; border-width: 0px 0px 0px 1px; border-style: dashed; border-color: rgb(165, 165, 165); border-image: initial; top: 0px; right: 12px;"
            />
            <div
              v-show="notEmpty(info.bottom)"
              style="position: absolute; height: 0px; width: 84px; border-width: 1px 0px 0px; border-style: dashed; border-color: rgb(165, 165, 165); border-image: initial; left: 0px; bottom: 12px;"
            />
