<template>
  <div class="timeLineNode">
    <div
      ...
      class="cellItem"
      @click="selectOne"
      @contextmenu.prevent.stop="showContextMenu(info,$event)"
      :class="{active:isActive}"
    >
      <div class="cellItemWarp">
        <Cell
          v-for="(animate,i) in info.animate"
          :key="i"
          :animates="info.animate"
          :info="animate"
      ...
      >
        <i
          class="addFrame el-icon-circle-plus"
          v-if="info.animate==null||info.animate.length==0"
          @click="addFrame($event,info)"
        />
      </el-tooltip>
    </div>
    <div class="ced">
