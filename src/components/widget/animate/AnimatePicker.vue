  ...
  <div class="animatePicker">
    <div class="tabsWarp">
      <el-tabs v-model="activeName">
        <el-tab-pane
          v-for="group in Metadata.Animate"
          :key="group.value"
          :name="group.value"
        ...
        >
          <div class="itemWarp">
            <div
              class="item"
              :class="{active:isActive(itemin.value)}"
              v-for="itemin in group.options"
              :key="itemin.value"
              @click="selectOne(itemin.value)"
              @mouseenter="preview($event,itemin,true)"
              @mouseleave="preview($event,itemin,false)"
            >
              <div class="icon">
        ...
        <el-tab-pane
          ...
          label="设置"
        >
          <span slot="label"><i class="el-icon-setting" /></span>
          <div class="itemWarp">
            <el-form
              size="mini"
              label-width="80px"
            ...
            >
              ...
              >
                <el-select v-model="info.timingFunction">
                  <el-option
                    v-for="group in Metadata.AnimationTimingFunction"
                    :key="group.value"
                    :value="group.value"
                    :label="group.label||group.value"
                  />
