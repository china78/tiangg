    ...
    >
      <div class="left-slider">
        ...
        <div
          class="a7b"
          ref="sliderNode"
          data-deselect-layers="true"
          @scroll="scroll($event,['scrollTop'])"
        >
          <div>
            <animate-layer-node
              v-if="rootNode"
      ...
      >
        <div
          class="cursor"
          @mousedown="timelineStart"
          :style="{left:((time/1000)*((timeSpace.length)*timeSpace.num)-scrollLeft)+'px'}"
        >
          <div class="cum">
            <svg
              width="24px"
          ...
          <div class="cuk">
            <div
              class="timetip"
              v-if="cursorPos.time"
            >{{parseFloat(time/1000).toFixed(2)+'s'}}</div>
          </div>
        </div>
        <div class="timeline">
          <div
