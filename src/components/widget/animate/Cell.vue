<template>
  <div
    class="timeLineNodeCell"
    @click.stop
    :style="cellStyle"
    @mousedown="mousedown($event,'center')"
  >
    <div
      class="timeLineNodeCellOne"
      :style="oneCellStyle"
    >
      <el-popover
        placement="top"
      ...
      <div
        class="presentation left"
        @click.stop
        @mousedown.stop="mousedown($event,'left')"
      />
      <div
        class="presentation right"
        @click.stop
      ...
      >
        <i
          class="add left el-icon-circle-plus"
          @click.stop="addFrame(0)"
        />
      </el-tooltip>
      <el-tooltip
        v-if="!info.infinite"
      ...
      >
        <i
          class="add right el-icon-circle-plus"
          @click.stop="addFrame(1)"
        />
      </el-tooltip>
    </div>
  </div>
