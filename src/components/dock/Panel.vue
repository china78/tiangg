<template>
  <div
    ...
    @keyup="keydown($event)"
    tabindex="0"
    @click.capture="panelSelect($event)"
    class="ui-dock-panel"
    ...
    <div class="control">
      ...
      >
        ...
        <el-dropdown-menu slot="dropdown">
          <el-dropdown-item
            :disabled="!selectPanel.close"
            command="close"
          ><i
              v-show="!selectPanel.close"
              class="iconfont icon-disablenotallowed"
            ></i> 关闭</el-dropdown-item>
          <el-dropdown-item
            :disabled="!selectPanel.pop"
            command="jump"
          ><i
              v-show="!selectPanel.pop"
              class="iconfont icon-disablenotallowed"
            ></i> 弹出</el-dropdown-item>
        </el-dropdown-menu>
      </el-dropdown>
    </div>
    <div
      v-if="showMask&&canDragIn"
      :style="{'z-index':level}"
