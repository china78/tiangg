  ...
  >
    ...
    <template v-if="!isRootNode && stacked">
      <div class="item-h">
        ...
        <a
          class="item-sub"
          @click="moveLayer(Number.MAX_VALUE)"
          v-show="!isRootNode"
        >
          置顶
        </a>
        <a
          class="item-sub"
          @click="moveLayer(Number.MIN_VALUE)"
          v-show="!isRootNode"
        >
          置底
        </a>
